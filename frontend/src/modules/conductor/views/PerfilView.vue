<template>
  <ConductorLayout titulo="Mi Perfil">
    ...
    <div class="card info-card">
      ...
      <p><strong>Estado:</strong>
        <span class="badge" :class="perfil?.activo ? 'badge-success' : 'badge-danger'">
...
const guardarPerfil = async () => {
  ...
  msgPerfil.value = '';
  try {
    const data = await conductorStore.updatePerfil(form.value);
...
const cambiarPassword = async () => {
  ...
  msgPass.value = '';
  try {
    await conductorStore.changePassword(passForm.value);
...
onMounted(async () => {
  const data = await conductorStore.fetchPerfil();
  perfil.value = data;
